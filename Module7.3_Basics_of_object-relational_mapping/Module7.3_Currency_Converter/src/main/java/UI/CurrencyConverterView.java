...
public class CurrencyConverterView extends Application {
    ...
    private Button addCurencyButton;
    ...
    public void start(Stage primaryStage) {
        ...
        addCurencyButton = new Button("Add Currency");
        ...
        layout.add(addCurencyButton, 2, 4); // Spanning across 2 columns
    ...
    public void addCurrencyToView(Currency newCurrency) {
        if (newCurrency != null) {
            sourceCurrencyBox.getItems().add(newCurrency);
            targetCurrencyBox.getItems().add(newCurrency);
        }
    }
    ...
    public Button getAddCurencyButton() {
        return addCurencyButton;
    }
